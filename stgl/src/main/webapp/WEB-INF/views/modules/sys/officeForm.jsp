...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/sys/office/list?id=${office.parent.id}&parentIds=${office.parentIds}">结构列表</a></li>
    <li class="active"><a
            href="${ctx}/sys/office/form?id=${office.id}&parent.id=${office.parent.id}">结构<shiro:hasPermission
...
<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        <label class="control-label">结构名称:</label>
        <div class="controls">
...
--%>
    ...
    <div class="control-group">
        <label class="control-label">结构级别:</label>
        <div class="controls">
