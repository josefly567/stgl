...
//		}
    ...
    public String assign(Role role, Model model) {
        ...
        System.out.println("1-----------sfdotz@gmail.com-----------" + role + "是role的值,当前类是RoleController.assign()");
        System.out.println("-----------sfdotz@gmail.com-----------" + role.getId() + "是role.getId()的值,当前类是RoleController.assign()");
        List<User> userList = systemService.findUser(new User(new Role(role.getId())));
        System.out.println("2-----------sfdotz@gmail.com-----------" + role + "是role的值,当前类是RoleController.assign()");
